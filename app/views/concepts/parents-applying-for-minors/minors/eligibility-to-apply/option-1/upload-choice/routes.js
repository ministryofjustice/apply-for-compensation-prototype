...
router.post('/concepts/parents-applying-for-minors/minors/eligibility-to-apply/option-1/upload-choice', function (req, res) {
  // Get the answer from the query string
  var minorUploadChoice = req.session.data['minorUploadChoice']

  if (minorUploadChoice === 'Yes') {
    // Redirect to the relevant page
    res.redirect('/concepts/parents-applying-for-minors/minors/eligibility-to-apply/option-1/upload')
  } else {
...
router.get('/concepts/parents-applying-for-minors/minors/eligibility-to-apply/option-1/upload-choice', function (req, res) {
  res.render('concepts/parents-applying-for-minors/minors/eligibility-to-apply/option-1/upload-choice/index', content)
})
