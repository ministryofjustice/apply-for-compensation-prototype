module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/most-common-first/most-common/broken-bones', function (req, res) {
    ...
    if (mostCommonInjuriesBreaks.includes(' Head, face or neck')) {
      res.redirect('/concepts/physical-injuries/most-common-first/most-common/broken-bones/head-face-neck')
    } else if (mostCommonInjuriesBreaks.includes(' Arm or hand')) {
      res.redirect('/concepts/physical-injuries/most-common-first/most-common/broken-bones/arms')
