module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v2/head-face-neck/injuries/teeth', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v2/head-face-neck/injuries/teeth/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v2/head-face-neck/injuries/teeth/index', content)
  })
  // END__######################################################################################################
}
