module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v2/legs/injuries/ankle', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v2/legs/injuries/ankle/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v2/legs/injuries/ankle/index', content)
  })
  // END__######################################################################################################
}
