module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v2/torso/injuries/surface', function (req, res) {
    ...
    if (torsoInjuredParts.includes('Abdomen')) {
      res.redirect('/concepts/physical-injuries/one-q-page-v2/torso/injuries/abdomen')
  ...
  router.get('/concepts/physical-injuries/one-q-page-v2/torso/injuries/surface/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v2/torso/injuries/surface/index', content)
  })
  // END__######################################################################################################
}
