module.exports = function (router, content) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/gp-details/error-building-street-blank', function (req, res) {
    res.render('application/gp-details/error-building-street-blank', content)
  })

  router.get('/concepts/physical-injuries/one-q-page-v3/gp-details/error-town-city-blank', function (req, res) {
    res.render('application/gp-details/error-town-city-blank', content)
  })

  router.get('/concepts/physical-injuries/one-q-page-v3/gp-details/error-postcode', function (req, res) {
