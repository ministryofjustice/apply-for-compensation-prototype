module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v3/arms/injuries/shoulder', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/arms/injuries/shoulder/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v3/arms/injuries/shoulder/index', content)
  })
  // END__######################################################################################################
}
