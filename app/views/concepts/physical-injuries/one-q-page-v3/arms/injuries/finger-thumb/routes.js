module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v3/arms/injuries/finger-thumb', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/arms/injuries/finger-thumb/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v3/arms/injuries/finger-thumb/index', content)
  })
  // END__######################################################################################################
}
