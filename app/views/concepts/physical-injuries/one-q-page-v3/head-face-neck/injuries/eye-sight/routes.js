module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/eye-sight', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/eye-sight/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/eye-sight/index', content)
  })
  // END__######################################################################################################
}
