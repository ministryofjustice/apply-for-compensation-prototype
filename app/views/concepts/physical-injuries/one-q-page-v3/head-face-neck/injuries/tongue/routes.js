module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/tongue', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/tongue/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/tongue/index', content)
  })
  // END__######################################################################################################
}
