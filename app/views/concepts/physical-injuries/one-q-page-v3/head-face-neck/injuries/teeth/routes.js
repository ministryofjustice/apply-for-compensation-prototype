module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/teeth', function (req, res) {

    let headNeckFaceInjuredPart = req.session.data['headNeckFaceInjuredPart'] || []
    let injuredParts = req.session.data['injuredParts'] || []

    // Go to detail
    if (headNeckFaceInjuredPart.includes('Tongue')) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/teeth/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v3/head-face-neck/injuries/teeth/index', content)
  })
  // END__######################################################################################################
}
