module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page-v3/legs/injuries/hip', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page-v3/legs/injuries/hip/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page-v3/legs/injuries/hip/index', content)
  })
  // END__######################################################################################################
}
