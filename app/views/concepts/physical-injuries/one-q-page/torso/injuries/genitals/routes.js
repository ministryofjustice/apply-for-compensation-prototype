module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page/torso/injuries/genitals', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page/torso/injuries/genitals/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page/torso/injuries/genitals/index', content)
  })
  // END__######################################################################################################
}
