module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page/torso/injuries/chest', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page/torso/injuries/chest/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page/torso/injuries/chest/index', content)
  })
  // END__######################################################################################################
}
