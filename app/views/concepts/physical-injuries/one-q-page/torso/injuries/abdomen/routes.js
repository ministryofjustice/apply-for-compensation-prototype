module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page/torso/injuries/abdomen', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page/torso/injuries/abdomen/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page/torso/injuries/abdomen/index', content)
  })
  // END__######################################################################################################
}
