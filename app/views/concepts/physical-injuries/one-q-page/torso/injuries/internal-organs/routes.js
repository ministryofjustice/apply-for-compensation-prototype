module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page/torso/injuries/internal-organs', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page/torso/injuries/internal-organs/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page/torso/injuries/internal-organs/index', content)
  })
  // END__######################################################################################################
}
