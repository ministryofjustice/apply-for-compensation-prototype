module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page/legs', function (req, res) {
    ...
    if (legInjuredParts.includes('Ankle')) {
      res.redirect('/concepts/physical-injuries/one-q-page/legs/injuries/ankle')
  ...
  router.get('/concepts/physical-injuries/one-q-page/legs/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page/legs/index', content)
  })
  // END__######################################################################################################
}
