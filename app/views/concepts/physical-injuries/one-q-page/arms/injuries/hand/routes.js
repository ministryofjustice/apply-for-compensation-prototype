module.exports = function (router, content) {
  ...
  router.post('/concepts/physical-injuries/one-q-page/arms/injuries/hand', function (req, res) {
  ...
  router.get('/concepts/physical-injuries/one-q-page/arms/injuries/hand/', function (req, res) {
    res.render('concepts/physical-injuries/one-q-page/arms/injuries/hand/index', content)
  })
  // END__######################################################################################################
}
