...
module.exports = function (router, content) {
  ...
  router.post('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date', function (req, res) {
    ...
    var delayInDays = duration.asDays(); // take that number in years  - we can do that thanks to the Moment library
    ...
    //     return res.redirect('/concepts/applying-for-someone-else/minors/application/v1/reporting-delay')
    //   }
    // }
    ...
    if (delayInDays > 2){ //apply more than 2 years after the incident
      return res.redirect('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/application-delay')
    }
  ...
  router.get('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/', function (req, res) {
    res.render('concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/index', content)
  })

  router.get('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-blank', function (req, res) {
    res.render('concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-blank', content)
  })

  router.get('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-past', function (req, res) {
    res.render('concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-past', content)
  })

  router.get('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-format', function (req, res) {
    res.render('concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-format', content)
  })

  router.get('/concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-incomplete', function (req, res) {
      res.render('concepts/applying-for-someone-else/minors/application/v1/_3-incident-details/crime-reported-date/error-incomplete', content)
    })
  // END__######################################################################################################
}
