module.exports = function (router, content) {
  ...
  router.post('/concepts/applying-for-someone-else/minors/application/v1/_5-injuries/injured-body-parts/head-face-neck', function (req, res) {
    ...
    let injuredParts = req.session.data['injuredParts'] || []
     ...
     if (headFaceNeckInjuredParts.includes('Head or brain')) {
      res.redirect('/concepts/applying-for-someone-else/minors/application/v1/_5-injuries/injured-body-parts/head-face-neck/head')
    } else if (headFaceNeckInjuredParts.includes('Face or jaw')) {
      res.redirect('/concepts/applying-for-someone-else/minors/application/v1/_5-injuries/injured-body-parts/head-face-neck/face/')
    } else if (headFaceNeckInjuredParts.includes('Eye or eyesight')) {
      res.redirect('/concepts/applying-for-someone-else/minors/application/v1/_5-injuries/injured-body-parts/head-face-neck/eye-sight/')
