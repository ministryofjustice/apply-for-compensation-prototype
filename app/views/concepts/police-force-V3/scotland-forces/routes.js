...
router.post('/concepts/police-force-v3/scotland-forces', function (req, res) {
...
router.get('/concepts/police-force-v3/scotland-forces', function (req, res) {
  res.render('concepts/police-force-v3/scotland-forces/index', content)
})
