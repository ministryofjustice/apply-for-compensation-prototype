module.exports = function (router, content) {
  ...
  router.post('/concepts/police-force-v3/single-or-multiple-incidents', function (req, res) {
    ...
    if (singleOrMultipleIncidents === 'Over a period of time') {
      ...
      res.redirect('/concepts/police-force-v3/incident-date')
    }
  })

  // Pass the question in to the page
  router.get('/concepts/police-force-v3/single-or-multiple-incidents/', function (req, res) {
    res.render('concepts/police-force-v3/single-or-multiple-incidents/index', content)
  })
