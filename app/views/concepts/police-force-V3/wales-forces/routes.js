...
router.post('/concepts/police-force-v3/wales-forces', function (req, res) {
...
router.get('/concepts/police-force-v3/wales-forces', function (req, res) {
  res.render('concepts/police-force-v3/wales-forces/index', content)
})
