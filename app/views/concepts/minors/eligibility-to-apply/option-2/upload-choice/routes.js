...
router.post('/concepts/minors/eligibility-to-apply/option-2/upload-choice', function (req, res) {
...
router.get('/concepts/minors/eligibility-to-apply/option-2/upload-choice', function (req, res) {
  res.render('concepts/minors/eligibility-to-apply/option-2/upload-choice/index', content)
})
