module.exports = function(router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_08-treatment-adults/gp-visited', function(req, res) {
      ...
      if (registeredGP === 'Yes') {
        res.redirect('/concepts/third-party-reps/prototype/_08-treatment-adults/gp-details')
        ...
        if (visitedGP === 'Yes') {
          ...
          if (havePhysicalInjuries === 'Yes') {
            ...
            res.redirect('/concepts/third-party-reps/prototype/_08-treatment-adults/dentist-visited')
            } else {
  ...
  router.get('/concepts/third-party-reps/prototype/_08-treatment-adults/gp-visited/', function(req, res) {
    res.render('concepts/third-party-reps/prototype/_08-treatment-adults/gp-visited/index', content)
  })
