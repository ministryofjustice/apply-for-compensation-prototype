module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_06-injuries-adults/injured-body-parts/arms/', function (req, res) {
      ...
      if (armsInjuredParts.includes('Shoulder')) {
        res.redirect('/concepts/third-party-reps/prototype/_06-injuries-adults/injured-body-parts/arms/shoulder')
      } else if (armsInjuredParts.includes('Arm')) {
        res.redirect('/concepts/third-party-reps/prototype/_06-injuries-adults/injured-body-parts/arms/arm')
