...
module.exports = function (router, content) {
  ...
  //
  router.post('/concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end', function (req, res) {
  ...
  router.get('/concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/index', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-past', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-past', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-before-reported', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-before-reported', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-after-started', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-after-started', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-incomplete', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-adults/period-of-abuse-end/error-incomplete', content)
  })
  // END__######################################################################################################
}
