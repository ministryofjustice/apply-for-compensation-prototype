module.exports = function (router, content) {
  ...
  //
  router.post('/concepts/third-party-reps/prototype/_02-main-applicant-details/responsibility-who-with/minor', function (req, res) {
  ...
  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/responsibility-who-with/minor/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/responsibility-who-with/minor/index', content)
  })

  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/responsibility-who-with/minor/error', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/responsibility-who-with/minor/error', content)
  })
  // END__######################################################################################################
}
