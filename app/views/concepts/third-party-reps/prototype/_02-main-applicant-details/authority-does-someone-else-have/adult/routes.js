...
module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_02-main-applicant-details/authority-does-someone-else-have/adult', function (req, res) {
  ...
  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/authority-does-someone-else-have/adult/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/authority-does-someone-else-have/adult/index', content)
  })
  // END__######################################################################################################
}
