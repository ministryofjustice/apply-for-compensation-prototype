...
module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_02-main-applicant-details/context-main-applicant-details/adult', function (req, res) {
    ...
    if (repType === 'Birth, step or adoptive parent') {
  ...
  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/context-main-applicant-details/adult/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/context-main-applicant-details/adult/index', content)
  })
  // END__######################################################################################################
}
