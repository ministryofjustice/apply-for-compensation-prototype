module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/minor', function (req, res) {
    ...
    if (sharedResponsibility === 'Yes') {
      res.redirect('/concepts/third-party-reps/prototype/_02-main-applicant-details/responsibility-who-with/minor')
  ...
  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/minor', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/minor/index', content)
  })

  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/minor/error', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/minor/error', content)
  })
  // END__######################################################################################################
}
