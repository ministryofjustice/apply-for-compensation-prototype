module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility', function (req, res) {
  ...
  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/index', content)
  })

  router.get('/concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/error', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_02-main-applicant-details/do-you-share-responsibility/error', content)
  })
  // END__######################################################################################################
}
