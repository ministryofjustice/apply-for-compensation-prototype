...
module.exports = function (router, content) {
  ...
  //
  router.post('/concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end', function (req, res) {
    ...
    if (dateOfEndOfPOA < deadlineDate){ //apply more than 2 years after the end of the period of abuse
      return res.redirect('/concepts/third-party-reps/prototype/_04-incident-details-minors/application-delay')
    }
    ...
    if ( dateHelper.isReportedOver48h(endofPeriodOfAbuseDate, reportingDate)){ // changing the end of period of abuse date is now triggering the reporting delay screen
      return res.redirect('/concepts/third-party-reps/prototype/_04-incident-details-minors/reporting-delay')
    }
  }
  ...
  // else we're under 2 days
    ...
    res.redirect('/concepts/third-party-reps/prototype/_04-incident-details-minors/incident-location')
  })

  // Pass the question in to the page
  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/index', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-past', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-past', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-before-reported', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-before-reported', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-after-started', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-after-started', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-incomplete', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/period-of-abuse-end/error-incomplete', content)
  })
  // END__######################################################################################################
}
