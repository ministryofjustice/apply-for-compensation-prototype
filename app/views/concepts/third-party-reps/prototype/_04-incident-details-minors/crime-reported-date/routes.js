...
module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date', function (req, res) {
    ...
    //     return res.redirect('/concepts/third-party-reps/prototype/reporting-delay')
    //   }
    // }
  ...
  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/index', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-blank', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-blank', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-past', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-past', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-format', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-format', content)
  })

  router.get('/concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-incomplete', function (req, res) {
      res.render('concepts/third-party-reps/prototype/_04-incident-details-minors/crime-reported-date/error-incomplete', content)
    })
  // END__######################################################################################################
}
