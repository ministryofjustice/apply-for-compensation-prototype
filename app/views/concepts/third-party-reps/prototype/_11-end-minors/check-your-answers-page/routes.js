...
module.exports = function (router, content) {
  ...
  // File: check-your-answers-page
   router.post('/concepts/third-party-reps/prototype/_11-end-minors/check-your-answers-page', function (req, res) {
     ...
     if (ageAtApplication > (-365 * ageToCheck)){ //if age at application is the target age or under
       return res.redirect('/concepts/third-party-reps/prototype/_11-end-minors/declaration-under-12')
     } else {
       res.redirect('/concepts/third-party-reps/prototype/_11-end-minors/declaration')
     }
   })

   // Pass the question in to the page
   router.get('/concepts/third-party-reps/prototype/_11-end-minors/check-your-answers-page/', function (req, res) {
     res.render('concepts/third-party-reps/prototype/_11-end-minors/check-your-answers-page/index', content)
   })

   // Pass the question in to the page
   router.get('/concepts/third-party-reps/prototype/_11-end-minors/check-your-answers-page/', function (req, res) {
     res.render('concepts/third-party-reps/prototype/_11-end-minors/check-your-answers-page/cya', content)
   })
  // END__######################################################################################################
}
