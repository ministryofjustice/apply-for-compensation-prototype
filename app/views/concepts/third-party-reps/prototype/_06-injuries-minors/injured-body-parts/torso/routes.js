module.exports = function(router, content) {
    ...
    router.post('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/', function(req, res) {
        ...
        if (torsoInjuredParts.includes('Shoulder')) {
          res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/shoulder')
        } else if (torsoInjuredParts.includes('Chest')) {
          res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/chest')
        } else if (torsoInjuredParts.includes('Abdomen')) {
          res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/abdomen')
        } else if (torsoInjuredParts.includes('Back')) {
          res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/back')
        } else if (torsoInjuredParts.includes('Pelvis')) {
          res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/pelvis')
        } else if (torsoInjuredParts.includes('Genitals')) {
          res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/torso/genitals')
