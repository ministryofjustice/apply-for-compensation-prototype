module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/legs', function (req, res) {
      ...
      if (legInjuredParts.includes('Hip')) {
        res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/legs/hip')
      } else if (legInjuredParts.includes('Leg')) {
        res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/injured-body-parts/legs/leg')
