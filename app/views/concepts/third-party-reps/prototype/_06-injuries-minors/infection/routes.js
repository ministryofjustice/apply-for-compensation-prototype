...
module.exports = function (router, content) {
  ...
  router.post('/concepts/third-party-reps/prototype/_06-injuries-minors/infection', function (req, res) {
    ...
    if (haveInfection === 'Yes' && incidentType === 'Sexual assault or abuse') {
      res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/infection/details-vosaa')
    } else if (haveInfection === 'Yes' && incidentType !== 'Sexual assault or abuse') {
      res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/infection/details')
    } else {
      ...
      if (ageAtApplication > (-365 * ageToCheck)){ //if age at application is the target age or under
        return res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/context-about-dmi')
      }
      ...
      res.redirect('/concepts/third-party-reps/prototype/_06-injuries-minors/context-pregnancy')
    }
  })
  ...
  router.post('/concepts/third-party-reps/prototype/_06-injuries-minors/infection/details', function (req, res) {
      // only show pregnancy questions if over a certain age
  ...
  router.post('/concepts/third-party-reps/prototype/_06-injuries-minors/infection/details-vosaa', function (req, res) {
      // only show pregnancy questions if over a certain age
  ...
  router.get('/concepts/third-party-reps/prototype/_06-injuries-minors/infection/', function (req, res) {
    res.render('concepts/third-party-reps/prototype/_06-injuries-minors/infection/index', content)
  })
