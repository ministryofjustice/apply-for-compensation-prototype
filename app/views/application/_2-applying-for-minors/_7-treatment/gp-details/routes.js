module.exports = function (router, content) {
  // START__####################################################################################################
  router.post('/application/_2-applying-for-minors/_7-treatment/gp-details', function (req, res) {
  ...
  router.get('/application/_2-applying-for-minors/_7-treatment/gp-details/', function (req, res) {
    res.render('application/_2-applying-for-minors/_7-treatment/gp-details/index', content)
  })
