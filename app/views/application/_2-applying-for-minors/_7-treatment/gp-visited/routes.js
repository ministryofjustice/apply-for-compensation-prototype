module.exports = function(router, content) {
  ...
  router.post('/application/_2-applying-for-minors/_7-treatment/gp-visited', function(req, res) {
    ...
    if (registeredGP === 'Yes') {
      res.redirect('/application/_2-applying-for-minors/_7-treatment/gp-details')
      ...
      if (visitedGP === 'Yes') {
        ...
        if (havePhysicalInjuries === 'Yes') {
          ...
          res.redirect('/application/_2-applying-for-minors/_7-treatment/dentist-visited')
          } else {
  ...
  router.get('/application/_2-applying-for-minors/_7-treatment/gp-visited/', function(req, res) {
    res.render('application/_2-applying-for-minors/_7-treatment/gp-visited/index', content)
  })
