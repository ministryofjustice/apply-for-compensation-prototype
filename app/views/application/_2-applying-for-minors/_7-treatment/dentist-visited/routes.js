...
router.post('/application/_2-applying-for-minors/_7-treatment/dentist-visited', function (req, res) {
  ...
  if (visitedDentist === 'Yes') {
   res.redirect('/application/_2-applying-for-minors/_7-treatment/dentist-details')
...
router.get('/application/_2-applying-for-minors/_7-treatment/dentist-visited/', function (req, res) {
  res.render('application/_2-applying-for-minors/_7-treatment/dentist-visited/index', content)
})
