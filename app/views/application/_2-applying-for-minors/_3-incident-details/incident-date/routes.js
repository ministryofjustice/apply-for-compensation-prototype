...
module.exports = function (router, content) {
  ...
  router.post('/application/_2-applying-for-minors/_3-incident-details/incident-date', function (req, res) {
  ...
  router.get('/application/_2-applying-for-minors/_3-incident-details/incident-date/', function (req, res) {
    res.render('application/_2-applying-for-minors/_3-incident-details/incident-date/index', content)
  })

  router.get('/application/_2-applying-for-minors/_3-incident-details/incident-date/error-past', function (req, res) {
    res.render('application/_2-applying-for-minors/_3-incident-details/incident-date/error-past', content)
  })

  router.get('/application/_2-applying-for-minors/_3-incident-details/incident-date/error-before-reported', function (req, res) {
    res.render('application/_2-applying-for-minors/_3-incident-details/incident-date/error-before-reported', content)
  })

  router.get('/application/_2-applying-for-minors/_3-incident-details/incident-date/error-incomplete', function (req, res) {
    res.render('application/_2-applying-for-minors/_3-incident-details/incident-date/error-incomplete', content)
  })
  // END__######################################################################################################
}
