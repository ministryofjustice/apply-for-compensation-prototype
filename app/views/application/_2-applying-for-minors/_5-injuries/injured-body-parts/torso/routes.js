module.exports = function(router, content) {
    ...
    router.post('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/', function(req, res) {
        let torsoInjuredParts = req.session.data['torsoInjuredParts'] || []
        let injuredParts = req.session.data['injuredParts'] || []

        if (torsoInjuredParts.includes('Shoulder')) {
          res.redirect('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/shoulder')
        } else if (torsoInjuredParts.includes('Chest')) {
          res.redirect('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/chest')
        } else if (torsoInjuredParts.includes('Abdomen')) {
          res.redirect('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/abdomen')
        } else if (torsoInjuredParts.includes('Back')) {
          res.redirect('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/back')
        } else if (torsoInjuredParts.includes('Pelvis')) {
          res.redirect('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/pelvis')
        } else if (torsoInjuredParts.includes('Genitals')) {
          res.redirect('/application/_2-applying-for-minors/_5-injuries/injured-body-parts/torso/genitals')
