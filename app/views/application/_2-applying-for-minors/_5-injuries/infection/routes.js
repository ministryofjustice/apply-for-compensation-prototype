...
module.exports = function (router, content) {
  ...
  router.post('/application/_2-applying-for-minors/_5-injuries/infection', function (req, res) {
    ...
    if (haveInfection === 'Yes' && incidentType === 'Sexual assault or abuse') {
      res.redirect('/application/_2-applying-for-minors/_5-injuries/infection/details-vosaa')
    } else if (haveInfection === 'Yes' && incidentType !== 'Sexual assault or abuse') {
      res.redirect('/application/_2-applying-for-minors/_5-injuries/infection/details')
    } else {
      ...
      if (ageAtApplication > (-365 * ageToCheck)){ //if age at application is the target age or under
        return res.redirect('/application/_2-applying-for-minors/_5-injuries/context-about-dmi')
      }
      ...
      res.redirect('/application/_2-applying-for-minors/_5-injuries/context-pregnancy')
    }
  })
  ...
  router.post('/application/_2-applying-for-minors/_5-injuries/infection/details', function (req, res) {
      // only show pregnancy questions if over a certain age
  ...
  router.post('/application/_2-applying-for-minors/_5-injuries/infection/details-vosaa', function (req, res) {
      // only show pregnancy questions if over a certain age
  ...
  router.get('/application/_2-applying-for-minors/_5-injuries/infection/', function (req, res) {
    res.render('application/_2-applying-for-minors/_5-injuries/infection/index', content)
  })
