module.exports = function (router, content) {
  ...
  // File: name-other
  //
  router.post('/application/_0-save-and-return-screens/new-application/create-password/error-pw-both', function (req, res) {
  ...
  router.get('/application/_0-save-and-return-screens/new-application/create-password/error-pw-both', function (req, res) {
    res.render('application/_0-save-and-return-screens/new-application/create-password/error-pw-both/index', content)
  })
