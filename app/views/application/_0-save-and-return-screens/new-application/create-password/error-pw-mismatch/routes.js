module.exports = function (router, content) {
  ...
  // File: name-other
  //
  router.post('/application/_0-save-and-return-screens/new-application/create-password/error-pw-mismatch', function (req, res) {
  ...
  router.get('/application/_0-save-and-return-screens/new-application/create-password/error-pw-mismatch', function (req, res) {
    res.render('application/_0-save-and-return-screens/new-application/create-password/error-pw-mismatch/index', content)
  })
