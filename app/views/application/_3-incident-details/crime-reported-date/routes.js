...
module.exports = function (router, content) {
  ...
  router.post('/application/_3-incident-details/crime-reported-date', function (req, res) {
    ...
    if (delayInDays > 2){ //apply more than 2 years after the incident
      return res.redirect('/application/_3-incident-details/application-delay')
    }
  ...
  router.get('/application/_3-incident-details/crime-reported-date/', function (req, res) {
    res.render('application/_3-incident-details/crime-reported-date/index', content)
  })

  router.get('/application/_3-incident-details/crime-reported-date/error-blank', function (req, res) {
    res.render('application/_3-incident-details/crime-reported-date/error-blank', content)
  })

  router.get('/application/_3-incident-details/crime-reported-date/error-past', function (req, res) {
    res.render('application/_3-incident-details/crime-reported-date/error-past', content)
  })

  router.get('/application/_3-incident-details/crime-reported-date/error-format', function (req, res) {
    res.render('application/_3-incident-details/crime-reported-date/error-format', content)
  })

  router.get('/application/_3-incident-details/crime-reported-date/error-incomplete', function (req, res) {
      res.render('application/_3-incident-details/crime-reported-date/error-incomplete', content)
    })
  // END__######################################################################################################
}
