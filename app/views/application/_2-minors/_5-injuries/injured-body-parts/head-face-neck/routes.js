module.exports = function (router, content) {
  ...
  router.post('/application/_2-minors/_5-injuries/injured-body-parts/head-face-neck', function (req, res) {
    ...
    let injuredParts = req.session.data['injuredParts'] || []
     ...
     if (headFaceNeckInjuredParts.includes('Head or brain')) {
      res.redirect('/application/_2-minors/_5-injuries/injured-body-parts/head-face-neck/head')
    } else if (headFaceNeckInjuredParts.includes('Face or jaw')) {
      res.redirect('/application/_2-minors/_5-injuries/injured-body-parts/head-face-neck/face/')
    } else if (headFaceNeckInjuredParts.includes('Eye or eyesight')) {
      res.redirect('/application/_2-minors/_5-injuries/injured-body-parts/head-face-neck/eye-sight/')
    } else if (headFaceNeckInjuredParts.includes('Ear or hearing')) {
     res.redirect('/application/_2-minors/_5-injuries/injured-body-parts/head-face-neck/ear-hearing/')
