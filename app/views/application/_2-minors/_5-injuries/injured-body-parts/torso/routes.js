module.exports = function(router, content) {
    ...
    router.post('/application/_2-minors/_5-injuries/injured-body-parts/torso/', function(req, res) {
      ...
      if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
        ...
        if (torsoInjuredParts.includes('Shoulder')) {
          res.redirect('/application/_2-minors/_5-injuries/injured-body-parts/torso/shoulder')
