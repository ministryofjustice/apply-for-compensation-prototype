...
module.exports = function (router, content) {
  ...
  router.post('/application/_2-minors/_3-incident-details/crime-reported-date', function (req, res) {
    ...
    //     return res.redirect('/application/_2-minors/reporting-delay')
    //   }
    // }
    ...
    res.redirect('/application/_2-minors/_3-incident-details/police-force')
  })

  // Pass the question in to the page
  router.get('/application/_2-minors/_3-incident-details/crime-reported-date/', function (req, res) {
    res.render('application/_2-minors/_3-incident-details/crime-reported-date/index', content)
  })

  router.get('/application/_2-minors/_3-incident-details/crime-reported-date/error-blank', function (req, res) {
    res.render('application/_2-minors/_3-incident-details/crime-reported-date/error-blank', content)
  })

  router.get('/application/_2-minors/_3-incident-details/crime-reported-date/error-past', function (req, res) {
    res.render('application/_2-minors/_3-incident-details/crime-reported-date/error-past', content)
  })

  router.get('/application/_2-minors/_3-incident-details/crime-reported-date/error-format', function (req, res) {
    res.render('application/_2-minors/_3-incident-details/crime-reported-date/error-format', content)
  })

  router.get('/application/_2-minors/_3-incident-details/crime-reported-date/error-incomplete', function (req, res) {
      res.render('application/_2-minors/_3-incident-details/crime-reported-date/error-incomplete', content)
    })
  // END__######################################################################################################
}
