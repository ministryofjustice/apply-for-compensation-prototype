module.exports = function(router, content) {
  ...
  router.post('/application/_2-minors/_7-treatment/gp-visited', function(req, res) {
    ...
    if (registeredGP === 'Yes') {
      res.redirect('/application/_2-minors/_7-treatment/gp-details')
  ...
  router.get('/application/_2-minors/_7-treatment/gp-visited/', function(req, res) {
    res.render('application/_2-minors/_7-treatment/gp-visited/index', content)
  })
