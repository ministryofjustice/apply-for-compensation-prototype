module.exports = function (router, content) {
  ...
  router.post('/application/_2-minors/_7-treatment/context-treatment', function (req, res) {
    ...
    if ((havePhysicalInjuries === 'Yes') || (haveInfection === 'Yes') || (pregnancy === 'Yes') || (pregnancyLoss === 'Yes') ) {
      res.redirect('/application/_2-minors/_7-treatment/treatment-details')
    } else if (dmiDoYouHave === 'Yes') {
      res.redirect('/application/_2-minors/_7-treatment/dmi-treatment-types')
    } else {
  ...
  router.get('/application/_2-minors/_7-treatment/context-treatment/', function (req, res) {
    res.render('application/_2-minors/_7-treatment/context-treatment/index', content)
  })
  // END__######################################################################################################
}
