...
module.exports = function (router, content) {
  ...
  //
  router.post('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end', function (req, res) {
    ...
    if (dateOfEndOfPOA < deadlineDate){ //apply more than 2 years after the end of the period of abuse
      return res.redirect('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/application-delay')
    }
    ...
    if ( dateHelper.isReportedOver48h(endofPeriodOfAbuseDate, reportingDate)){ // changing the end of period of abuse date is now triggering the reporting delay screen
      return res.redirect('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/reporting-delay')
    }
  }
  ...
  // else we're under 2 days
    ...
    res.redirect('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/incident-location')
  })

  // Pass the question in to the page
  router.get('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/index', content)
  })

  router.get('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-past', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-past', content)
  })

  router.get('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-before-reported', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-before-reported', content)
  })

  router.get('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-after-started', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-after-started', content)
  })

  router.get('/application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-incomplete', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_3-incident-details/period-of-abuse-end/error-incomplete', content)
  })
  // END__######################################################################################################
}
