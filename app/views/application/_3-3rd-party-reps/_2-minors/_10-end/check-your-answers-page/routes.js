...
module.exports = function (router, content) {
  ...
  // File: check-your-answers-page
   router.post('/application/_3-3rd-party-reps/_2-minors/_10-end/check-your-answers-page', function (req, res) {
     ...
     if (ageAtApplication > (-365 * ageToCheck)){ //if age at application is the target age or under
       return res.redirect('/application/_3-3rd-party-reps/_2-minors/_10-end/declaration-under-12')
     } else {
       res.redirect('/application/_3-3rd-party-reps/_2-minors/_10-end/declaration')
     }
   })

   // Pass the question in to the page
   router.get('/application/_3-3rd-party-reps/_2-minors/_10-end/check-your-answers-page/', function (req, res) {
     res.render('application/_3-3rd-party-reps/_2-minors/_10-end/check-your-answers-page/index', content)
   })

   // Pass the question in to the page
   router.get('/application/_3-3rd-party-reps/_2-minors/_10-end/check-your-answers-page/', function (req, res) {
     res.render('application/_3-3rd-party-reps/_2-minors/_10-end/check-your-answers-page/cya', content)
   })
  // END__######################################################################################################
}
