module.exports = function (router, content) {
  ...
  router.post('/application/_3-3rd-party-reps/_2-minors/_1-rep-details/address-org', function (req, res) {
  ...
  router.get('/application/_3-3rd-party-reps/_2-minors/_1-rep-details/address-org/', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_1-rep-details/address-org/index', content)
  })
  // END__######################################################################################################
}
