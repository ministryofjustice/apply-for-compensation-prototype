module.exports = function (router, content) {
  ...
  router.post('/application/_3-3rd-party-reps/_2-minors/_1-rep-details/address', function (req, res) {
  ...
  router.get('/application/_3-3rd-party-reps/_2-minors/_1-rep-details/address/', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_1-rep-details/address/index', content)
  })
  // END__######################################################################################################
}
