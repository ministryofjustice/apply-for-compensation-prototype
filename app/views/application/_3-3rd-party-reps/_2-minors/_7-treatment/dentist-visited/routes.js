...
router.post('/application/_3-3rd-party-reps/_2-minors/_7-treatment/dentist-visited', function (req, res) {
  ...
  if (visitedDentist === 'Yes') {
   res.redirect('/application/_3-3rd-party-reps/_2-minors/_7-treatment/dentist-details')
...
router.get('/application/_3-3rd-party-reps/_2-minors/_7-treatment/dentist-visited/', function (req, res) {
  res.render('application/_3-3rd-party-reps/_2-minors/_7-treatment/dentist-visited/index', content)
})
