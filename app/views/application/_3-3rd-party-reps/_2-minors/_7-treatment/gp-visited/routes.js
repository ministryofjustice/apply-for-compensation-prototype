module.exports = function(router, content) {
  ...
  router.post('/application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-visited', function(req, res) {
    ...
    if (registeredGP === 'Yes') {
      res.redirect('/application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-details')
      ...
      if (visitedGP === 'Yes') {
        ...
        if (havePhysicalInjuries === 'Yes') {
          ...
          res.redirect('/application/_3-3rd-party-reps/_2-minors/_7-treatment/dentist-visited')
          } else {
  ...
  router.get('/application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-visited/', function(req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-visited/index', content)
  })
