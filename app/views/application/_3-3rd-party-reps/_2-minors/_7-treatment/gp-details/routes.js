module.exports = function (router, content) {
  // START__####################################################################################################
  router.post('/application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-details', function (req, res) {
  ...
  router.get('/application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-details/', function (req, res) {
    res.render('application/_3-3rd-party-reps/_2-minors/_7-treatment/gp-details/index', content)
  })
