module.exports = function(router, content) {
    ...
    router.post('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/torso/', function(req, res) {
      ...
      if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
        ...
        if (torsoInjuredParts.includes('Shoulder')) {
          res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/torso/shoulder')
        } else if (torsoInjuredParts.includes('Chest')) {
          res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/torso/chest')
