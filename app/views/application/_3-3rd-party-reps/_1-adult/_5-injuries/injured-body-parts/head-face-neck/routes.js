module.exports = function (router, content) {
  ...
  router.post('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      let injuredParts = req.session.data['injuredParts'] || []
       ...
       if (headFaceNeckInjuredParts.includes('Head or brain')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/head')
      } else if (headFaceNeckInjuredParts.includes('Face or jaw')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/face/')
      } else if (headFaceNeckInjuredParts.includes('Eye or eyesight')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/eye-sight/')
      } else if (headFaceNeckInjuredParts.includes('Ear or hearing')) {
       res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/ear-hearing/')
      } else if (headFaceNeckInjuredParts.includes('Nose')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/nose/')
      } else if (headFaceNeckInjuredParts.includes('Mouth')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/mouth/')
      } else if (headFaceNeckInjuredParts.includes('Neck')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/neck/')
      } else if (headFaceNeckInjuredParts.includes('Skin')) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_5-injuries/injured-body-parts/head-face-neck/skin/')
