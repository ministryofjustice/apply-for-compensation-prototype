module.exports = function (router, content) {
  // START__####################################################################################################
  router.post('/application/_3-3rd-party-reps/_1-adult/_7-treatment/dentist-details', function (req, res) {
  ...
  router.get('/application/_3-3rd-party-reps/_1-adult/_7-treatment/dentist-details/', function (req, res) {
    res.render('application/_3-3rd-party-reps/_1-adult/_7-treatment/dentist-details/index', content)
  })
