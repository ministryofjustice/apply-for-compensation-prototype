module.exports = function (router, content) {
  ...
  router.post('/application/_3-3rd-party-reps/_1-adult/_7-treatment/context-treatment', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if ((havePhysicalInjuries === 'Yes') || (haveInfection === 'Yes') || (pregnancy === 'Yes') || (pregnancyLoss === 'Yes') ) {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_7-treatment/treatment-details')
      } else if (dmiDoYouHave === 'Yes') {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_7-treatment/dmi-treatment-types')
      } else {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_7-treatment/gp-registered')
      }
  ...
  router.get('/application/_3-3rd-party-reps/_1-adult/_7-treatment/context-treatment/', function (req, res) {
    res.render('application/_3-3rd-party-reps/_1-adult/_7-treatment/context-treatment/index', content)
  })
  // END__######################################################################################################
}
