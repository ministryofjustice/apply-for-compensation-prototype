module.exports = function(router, content) {
  ...
  router.post('/application/_3-3rd-party-reps/_1-adult/_7-treatment/gp-visited', function(req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (registeredGP === 'Yes') {
        res.redirect('/application/_3-3rd-party-reps/_1-adult/_7-treatment/gp-details')
  ...
  router.get('/application/_3-3rd-party-reps/_1-adult/_7-treatment/gp-visited/', function(req, res) {
    res.render('application/_3-3rd-party-reps/_1-adult/_7-treatment/gp-visited/index', content)
  })
