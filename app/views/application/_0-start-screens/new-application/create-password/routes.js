module.exports = function (router, content) {
  ...
  // File: name-other
  //
  router.post('/application/_0-start-screens/new-application/create-password', function (req, res) {
  ...
  router.get('/application/_0-start-screens/new-application/create-password/', function (req, res) {
    res.render('application/_0-start-screens/new-application/create-password/index', content)
  })
