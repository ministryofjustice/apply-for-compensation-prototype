module.exports = function (router, content) {
  ...
  router.post('/application/_5-injuries/injured-body-parts/head-face-neck', function (req, res) {
    ...
    if (buttonClicked === 'Continue') {
      ...
      let injuredParts = req.session.data['injuredParts'] || []
       ...
       if (headFaceNeckInjuredParts.includes('Head or brain')) {
        res.redirect('/application/_5-injuries/injured-body-parts/head-face-neck/head')
