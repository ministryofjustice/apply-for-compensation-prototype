module.exports = function (router, content) {
  ...
  router.post('/application/_5-injuries/injured-body-parts/legs', function (req, res) {
    let legInjuredParts = req.session.data['legInjuredParts'] || []
    let injuredParts = req.session.data['injuredParts'] || []

    if (legInjuredParts.includes('Hip')) {
      res.redirect('/application/_5-injuries/injured-body-parts/legs/hip')
    } else if (legInjuredParts.includes('Leg')) {
      res.redirect('/application/_5-injuries/injured-body-parts/legs/leg')
