module.exports = function (router, content) {
  ...
  router.post('/application/_5-injuries/injured-body-parts/torso/shoulder', function (req, res) {
    ...
    if (buttonClicked === 'Continue') {
      ...
      if (torsoInjuredParts.includes('Chest')) {
        res.redirect('/application/_5-injuries/injured-body-parts/torso/chest')
      } else if (torsoInjuredParts.includes('Abdomen')) {
        res.redirect('/application/_5-injuries/injured-body-parts/torso/abdomen')
      } else if (torsoInjuredParts.includes('Back')) {
        res.redirect('/application/_5-injuries/injured-body-parts/torso/back')
