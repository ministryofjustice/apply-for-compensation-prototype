module.exports = function (router, content) {
  ...
  router.post('/application/_5-injuries/injured-body-parts/arms/', function (req, res) {
    let armsInjuredParts = req.session.data['armsInjuredParts'] || []
    let injuredParts = req.session.data['injuredParts'] || []

    if (armsInjuredParts.includes('Shoulder')) {
      res.redirect('/application/_5-injuries/injured-body-parts/arms/shoulder')
    } else if (armsInjuredParts.includes('Arm')) {
      res.redirect('/application/_5-injuries/injured-body-parts/arms/arm')
