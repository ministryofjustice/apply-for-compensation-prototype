module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_4-offender/contact-with-offender', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (contactOffender === 'No')  {
        ...
        res.redirect('/application/_1-adult/_4-offender/what-is-relationship')
      }
  ...
  router.get('/application/_1-adult/_4-offender/contact-with-offender/', function (req, res) {
    res.render('application/_1-adult/_4-offender/contact-with-offender/index', content)
  })

  // Pass the question in to the error page
  router.get('/application/_1-adult/_4-offender/contact-with-offender/error', function (req, res) {
    res.render('application/_1-adult/_4-offender/contact-with-offender/error', content)
  })
  // END__######################################################################################################
}
