module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_5-injuries/injured-body-parts/arms/', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (armsInjuredParts.includes('Shoulder')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/arms/shoulder')
      } else if (armsInjuredParts.includes('Arm')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/arms/arm')
      } else if (armsInjuredParts.includes('Elbow')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/arms/elbow')
      } else if (armsInjuredParts.includes('Wrist')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/arms/wrist')
      } else if (armsInjuredParts.includes('Hand')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/arms/hand')
      } else if (armsInjuredParts.includes('Finger and thumb')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/arms/finger-thumb')
