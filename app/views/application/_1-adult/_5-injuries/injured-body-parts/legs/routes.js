module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_5-injuries/injured-body-parts/legs', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (legInjuredParts.includes('Hip')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/legs/hip')
      } else if (legInjuredParts.includes('Leg')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/legs/leg')
      } else if (legInjuredParts.includes('Knee')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/legs/knee')
      } else if(legInjuredParts.includes('Ankle')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/legs/ankle')
      } else if(legInjuredParts.includes('Foot')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/legs/foot')
