module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_5-injuries/injured-body-parts', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (injuredParts.includes('Head, face or neck')) {
        res.redirect('/application/_1-adult/_5-injuries/injured-body-parts/head-face-neck')
