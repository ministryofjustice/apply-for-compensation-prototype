...
module.exports = function (router, content) {
  ...
  //
  router.post('/application/_1-adult/_3-incident-details/period-of-abuse-end', function (req, res) {
  ...
  router.get('/application/_1-adult/_3-incident-details/period-of-abuse-end/', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/period-of-abuse-end/index', content)
  })

  router.get('/application/_1-adult/_3-incident-details/period-of-abuse-end/error-past', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/period-of-abuse-end/error-past', content)
  })

  router.get('/application/_1-adult/_3-incident-details/period-of-abuse-end/error-before-reported', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/period-of-abuse-end/error-before-reported', content)
  })

  router.get('/application/_1-adult/_3-incident-details/period-of-abuse-end/error-after-started', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/period-of-abuse-end/error-after-started', content)
  })

  router.get('/application/_1-adult/_3-incident-details/period-of-abuse-end/error-incomplete', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/period-of-abuse-end/error-incomplete', content)
  })
  // END__######################################################################################################
}
