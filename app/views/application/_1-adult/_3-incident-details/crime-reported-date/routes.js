...
module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_3-incident-details/crime-reported-date', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      res.redirect('/application/_1-adult/_3-incident-details/police-force')
  ...
  router.get('/application/_1-adult/_3-incident-details/crime-reported-date/', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/crime-reported-date/index', content)
  })

  router.get('/application/_1-adult/_3-incident-details/crime-reported-date/error-blank', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/crime-reported-date/error-blank', content)
  })

  router.get('/application/_1-adult/_3-incident-details/crime-reported-date/error-past', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/crime-reported-date/error-past', content)
  })

  router.get('/application/_1-adult/_3-incident-details/crime-reported-date/error-format', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/crime-reported-date/error-format', content)
  })

  router.get('/application/_1-adult/_3-incident-details/crime-reported-date/error-incomplete', function (req, res) {
      res.render('application/_1-adult/_3-incident-details/crime-reported-date/error-incomplete', content)
    })
  // END__######################################################################################################
}
