module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_3-incident-details/single-or-multiple-incidents', function (req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (singleOrMultipleIncidents === 'Over a period of time') {
        ...
        res.redirect('/application/_1-adult/_3-incident-details/period-of-abuse-start')
      } else {
        ...
        res.redirect('/application/_1-adult/_3-incident-details/incident-date')
      }
  ...
  router.get('/application/_1-adult/_3-incident-details/single-or-multiple-incidents/', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/single-or-multiple-incidents/index', content)
  })

  // Pass the question in to the page
  router.get('/application/_1-adult/_3-incident-details/single-or-multiple-incidents/error', function (req, res) {
    res.render('application/_1-adult/_3-incident-details/single-or-multiple-incidents/error', content)
  })
  // END__######################################################################################################
}
