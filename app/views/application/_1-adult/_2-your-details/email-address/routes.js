module.exports = function (router, content) {
  ...
  router.post('/application/_1-adult/_2-your-details/email-address', function (req, res) {
  ...
  router.get('/application/_1-adult/_2-your-details/email-address/', function (req, res) {
    res.render('application/_1-adult/_2-your-details/email-address/index', content)
  })
  // Pass the question in to the page
  router.get('/application/_1-adult/_2-your-details/email-address/error', function (req, res) {
    res.render('application/_1-adult/_2-your-details/email-address/error', content)
  })
  // END__######################################################################################################
}
