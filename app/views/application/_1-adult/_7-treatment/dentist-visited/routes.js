module.exports = function(router, content) {
  ...
  router.post('/application/_1-adult/_7-treatment/dentist-visited', function(req, res) {
    ...
    if ( (buttonClicked === 'Save and continue') || (buttonClicked === 'Continue') ) {
      ...
      if (visitedDentist === 'Yes') {
        res.redirect('/application/_1-adult/_7-treatment/dentist-details')
  ...
  router.get('/application/_1-adult/_7-treatment/dentist-visited/', function(req, res) {
    res.render('application/_1-adult/_7-treatment/dentist-visited/index', content)
  })
