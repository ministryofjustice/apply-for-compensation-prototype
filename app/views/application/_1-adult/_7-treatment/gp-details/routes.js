module.exports = function (router, content) {
  // START__####################################################################################################
  router.post('/application/_1-adult/_7-treatment/gp-details', function (req, res) {
  ...
  router.get('/application/_1-adult/_7-treatment/gp-details/', function (req, res) {
    res.render('application/_1-adult/_7-treatment/gp-details/index', content)
  })
