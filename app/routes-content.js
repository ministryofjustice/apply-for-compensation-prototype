...
module.exports = {
    ...
    mentalHealthDiagnosisProcess:'Are you in the process of getting a diagnosis?',
    mentalHealthDiagnosisProcessHint:'Diagnosis process hint',
    mentalHealthWaitingListQuestion:'Are you on a waiting list?',
    mentalHealthWaitingListQuestionHint:'Waiting list hint',
    mentalHealthGPDetails:'Enter your GP Details',
    mentalHealthGPDetailsHint:'Waiting list hint',
    mentalHealthDiagnosedByQuestion:'Who diagnosed you with this mental health condition?',
