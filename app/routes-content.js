...
module.exports = {
    ...
    knowOffenderError: "Select yes if you know the assailant's name",
    offenderNameHint: "We will not contact the assailant.",
    offenderNameError: "Enter the assailant's name",
    ...
    offenderNameQuestionCA: 'Assailant\'s  name',
    ...
    whatIsRelationshipQuestion: "If you have contact with the assailant, describe it below",
